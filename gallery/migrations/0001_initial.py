...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gallery_photo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(related_name='albuns', to=orm['gallery.Album'])),
    ...
    models = {
        ...
        'gallery.photo': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'albuns'", 'to': "orm['gallery.Album']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
